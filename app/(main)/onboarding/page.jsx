...
const doctorFormSchema = z.object({
  ...
  experience: z
    .number()
    .min(1, "Atleast 1 Year of Experience is required")
    .max(70),
  credentialUrl: z
    .string()
    .url("Invalid URL")
    .min(5, "Credential URL is required"),
  description: z
    .string()
    ...
    return (
      <Card className="border-emerald-900/20">
        <CardContent className="pt-6">
          ...
          <form onSubmit={handleSubmit(docSubmit)} className="space-y-6">
